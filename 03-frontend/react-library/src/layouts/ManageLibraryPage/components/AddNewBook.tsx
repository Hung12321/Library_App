                    ...
                    <form method='POST'>
                        <div className='row'>
                            <div className='col-md-6 mb-3'>
                                ...
                                <input placeholder='Title' type="text" className='form-control' name='title' required
                                    onChange={e => setTitle(e.target.value)} value={title} />
                            </div>
                            <div className='col-md-3 mb-3'>
                                <label className='form-label'> Author </label>
                                <input placeholder='Author' type="text" className='form-control' name='author' required
                        ...
                        <div className='col-md-12 mb-3'>
                            ...
                            <textarea placeholder='Description' className='form-control' id='exampleFormControlTextarea1' rows={3}
                                onChange={e => setDescription(e.target.value)} value={description}></textarea>
                        </div>
                        <div className='col-md-3 mb-3'>
                            <label className='form-label'>Copies</label>
                            <input placeholder='Number' type='number' className='form-control' name='Copies' required
                                onChange={e => setCopies(Number(e.target.value))} value={copies} />
                        </div>
                        <input placeholder='Image' type='file' onChange={e => base64ConversionForImages(e)} />
                        <div>
